...
export default function SignIn(props: { disableCustomTheme?: boolean, nextPath?: string }) {
  const navigate = useNavigate();
  const nextPath = props.nextPath ? props.nextPath : "/boards"; 
  ...
  const handleForgotPassword = () => { alert("Too bad!"); };
