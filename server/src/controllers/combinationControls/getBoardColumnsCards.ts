...
async function getBoardColumnsCards(req: CustomRequest, res: Response) {
  try {
    ...
    await board.populate({ path: "columns", populate: { path: "cards" } });
...
export default getBoardColumnsCards; 